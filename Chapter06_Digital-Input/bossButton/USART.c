/*
	...
	Note that receiveByte() blocks -- it sits waits _forever_ for
	...
	If your're using these chips, see (e.g.) iom8.h for how it's done.
...
void printByte(uint8_t byte) {
	/* Converts a byte to string of decimal text, sends it */
	transmitByte('0' + (byte / 100));		/* Hundereds */
